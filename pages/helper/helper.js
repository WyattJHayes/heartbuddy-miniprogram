...
Page({
  data: {
    faqs: [
      { q: '它是 AI，聊了会不会被记住、被泄露？', a: '默认不存敏感身份；云端只用匿名 openid 关联数据，本地存储可控。整段对话只在你自己的手机上。' },
      { q: '它真的能帮到人吗？会不会只会说漂亮话？', a: '它像一张「被训练过的陪伴卡」：能接住、能复盘、能给你工具入口。帮不帮得到，试试最诚实。' },
      { q: '聊到一半停了，它会怎么样？', a: '不会逼问。你可以随时停下，第二天回来它还会在那个位置等你，不会评判。' },
      { q: '孩子一直说没事，我还要不要问？', a: '主动问一句「今天有没有想说说的事」本身就有价值——不问不代表没事，问一次代表在意。' },
      { q: '我已经很难受了，它要我做什么？', a: '先做 3 次深呼吸（呼吸页有引导），再聊天或去充电站选一两张卡。如果持续难受到影响生活，请直接使用求助页}。' },
      { q: '卸载小程序后记录还在吗？', a: '云端内容留在云端（跟随 openid），手机上的本地内容会清空。卸载不会伤害记录里的你。' },
      { q: '为什么有的回答很泛？', a: '当我们没有具体语境时，AI 只能给安全的泛话。把感受说得越具体，TA 越能给到贴合的话。' },
      { q: '多少钱？有没有广告？', a: '完全免费、没有广告。它是为「照顾自己」设计的，不靠数据赚钱。' }
    ],
    openFaq: -1,
    triageDone: false,
    ...
    askSituations: [              // 开口求助：处境选项（本地生成话术）
      ...
      { k: 'isolated', label: '感觉被大家孤立了' },
      { k: 'worthless', label: '觉得自己很没用' }
    ],
    scriptSituation: '',
    scriptText: '',
  ...
  // 常见疑问：点开/收起
  toggleFaq(e) { this.setData({ openFaq: this.data.openFaq === e.currentTarget.dataset.i ? -1 : e.currentTarget.dataset.i }); },
  // 复制《怎么陪孩子》小抄
  copyParentNote() {
    const d = new Date();
    const lines = [
      '《怎么陪一个正在压力里的孩子》——心语伴小抄',
      '',
      '① 别急着给方法：先听 TA 几句，再问「你希望我怎么做」。',
      '② 少评判的话：把「这有什么好慌的」换成「我听出你很慌，慌是正常的，我们看看能做什么」。',
      '③ 留一个出口：陪 TA 去校心理中心，或一起看看求助页——你不是唯一，更不是 TA 的负担。',
      '',
      '陪伴最好的位置是「站在旁边」，不是「站在前面挡着」。',
      '—— ' + (d.getMonth() + 1) + ' 月 ' + d.getDate() + ' 日'
    ];
    wx.setClipboardData({ data: lines.join('\n'), success: () => wx.showToast({ title: '已复制小抄 📋', icon: 'none' }) });
  },
  ...
  regenScript(k) {
    ...
    const TPL = {
      ...
      isolated: [
        `老师，我想说说最近的状态：班里大家好像总是有意无意绕开我，小组分组也没人跟我一组。我不知道哪里做错了，但每天一个人待着真的很难受。想请您帮我看看，是不是可以安排一些让我参与进去的机会。`,
        `跟您说件事：最近我总是一个人，吃饭、上课、回宿舍都是。不是我想独来独往，是插不进去。我有点撑不住了，希望有人能帮帮我。`
      ],
      worthless: [
        `爸/妈，最近我总觉得自己什么都做不好：成绩上不去、也比不过别人，有时候觉得自己很没用。我知道你们辛苦，可我真的需要听到你们说一句「你已经很努力了」，而不是「再加油」。`,
        `想跟你们说说心里话：我最近经常否定自己，觉得自己不值得被喜欢。这种感觉很沉，我快扛不住了。想请你们陪陪我，也想找心理老师聊一聊。`
      ],
      talk: [
