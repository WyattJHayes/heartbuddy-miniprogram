...
│   ├── mood/      情绪可视化（快速记录/8种心情/健康指数/14天洞察·连低连高解读/色带点天小结/日历/三件小事/时光信）
│   ├── assessment/ 考前焦虑自评 + 应对卡 + 分享给信任的人(脱敏复制) + 逐题洞察 + 3 天陪伴计划
│   ├── ops/       运营看板（危机闭环/本周与月度处理率/月度对比行/CSV/7日均值快照/来源分布/高危趋势+24h回访闭环）
│   ├── report/    周报 + 月度小结（Top3/上月对比/平均强度/情绪词云）+ 连续低日提醒 + 本周对自己说备注 + canvas 分享卡
│   ├── helper/    求助（热线/24h回访/回访关怀卡/呼吸放松/身体扫描/「我撑过来了」5步·进度存档续走/今日关怀/英语角）
