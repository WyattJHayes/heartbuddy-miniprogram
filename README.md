...
│   ├── mood/      情绪可视化（快速记录/8种心情/健康指数/14天洞察·连低连高解读/色带点天小结+写一句补记+长按管理/日历+长按管理·空白日可补记/今日未记录轻提醒/未打卡可一键回顶部记录/健康指数❓说明/三件小事·全完成庆祝/记录后暖心回应·分布一句话解读/最像此刻的一天回看/时光信）
...
│   ├── station/   情绪充电站（5 张可展开心理急救卡/一键跳呼吸·聊天·记下此刻心情/可分享）
│   ├── privacy/   隐私政策（全文）
