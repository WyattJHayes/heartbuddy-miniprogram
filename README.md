...
├── pages/
│   ├── welcome/   隐私 & AI 说明
│   ├── chat/      核心对话页（快捷情绪双闭环/英文角/天气/今日心语/晨间轻提醒/陪伴计划日任务提示/深夜工具箱/重新开始对话/长按珍藏）
...
│   ├── report/    周报 + 月度小结 + 「本周对自己说」备注（文字版+分享卡都带上）+ canvas 分享卡
│   ├── helper/    求助中心（热线/24h回访/呼吸放松/身体扫描/「我撑过来了」/今日关怀/英语角）
