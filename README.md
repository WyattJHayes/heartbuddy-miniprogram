...
│   ├── mood/      情绪可视化（快速记录/8种心情/健康指数/14天洞察·连低连高解读/色带点天小结+写一句补记+长按管理/日历+长按管理/今日未记录轻提醒/健康指数❓说明/三件小事/时光信）
...
│   ├── report/    周报 + 月度小结（Top3/上月对比/平均强度/情绪词云）+ 连续低日提醒 + 正向鼓励条 + 本周相对最好的一天 + 本周练习足迹 + 本周对自己说备注 + canvas 分享卡
