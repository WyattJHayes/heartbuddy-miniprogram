...
├── pages/
│   ├── welcome/   隐私 & AI 说明
│   ├── chat/      核心对话页（快捷情绪双闭环/此刻强度滑条/倾诉后小结算/英文角/天气/今日心语/晨间轻提醒/计划日提示/深夜工具箱/重新开始对话/长按珍藏）
...
│   ├── report/    周报 + 月度小结（Top3/上月对比/平均强度/情绪词云）+ 本周对自己说备注 + canvas 分享卡
│   ├── helper/    求助中心（热线/24h回访/呼吸放松/身体扫描/「我撑过来了」5步·进度存档续走/今日关怀/英语角）
